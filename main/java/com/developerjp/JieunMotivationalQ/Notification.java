...
public class Notification extends BroadcastReceiver {
    ...
    private static final String[] quotes = {
            ...
            "Don't be afraid to give up the good to go for the great. - attributed to John D. Rockefeller",
            "The journey of a thousand miles begins with one step. - Lao Tzu",
            "Hardships often prepare ordinary people for an extraordinary destiny. - C.S. Lewis",
            "You must do the things you think you cannot do. - Eleanor Roosevelt",
            "Keep your face always toward the sunshine—and shadows will fall behind you. - Walt Whitman",
            ...
            "Every man dies, not every man really lives. - William Wallace (Brave heart)",
            "It does not matter how slowly you go as long as you do not stop. - Confucius",
            "Act as if what you do makes a difference. It does. - William James",
            "You miss 100% of the shots you don't take. - Wayne Gretzky",
            "The only limit to our realization of tomorrow is our doubts of today. - Franklin D. Roosevelt",
            ...
            "The way to get started is to quit talking and begin doing. - Walt Disney",
            "It always seems impossible until it's done. - Nelson Mandela",
            "You are capable of more than you know. - Glinda the Good Witch (The Wizard of Oz)",
            "Hard work beats talent when talent doesn't work hard. - Tim Notke",
            "Don't wait for opportunity. Create it. - Anonymous",
            "Success is the sum of small efforts, repeated day in and day out. - Robert Collier",
            "The only thing standing between you and your goal is the story you keep telling yourself. - Jordan Belfort",
    ...
    private static final String CHANNEL_NAME = "Daily Quote Channel";
    private static final String CHANNEL_DESCRIPTION = "Channel for Daily Quotes";
